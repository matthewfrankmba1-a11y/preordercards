...
export const metadata = {
  title: 'The State of Sports Card Collecting in 2026 — PreorderCards Blog',
  description:
...
const ARTICLE_JSONLD = {
  ...
  '@type': 'BlogPosting',
  headline: 'The State of Sports Card Collecting in 2026',
  description:
    'A quick read on the 2026 trading card market: hobby box prices, EQL raffle releases, grading trends, and the biggest Topps and Bowman drops coming the rest of the year.',
    ...
    <>
      ...
      <header className="site-header compact">
        ...
        <div className="wrap header-content">
          <h1>The State of Sports Card Collecting in 2026</h1>
