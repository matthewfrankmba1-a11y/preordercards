        ...
        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:600px;background:#ffffff;border-radius:10px;padding:28px;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Helvetica,Arial,sans-serif;">
          <tr>
            <td>
              ...
              ${
                issue.releases.length
                  ? `<p style="font-size:12px;line-height:1.5;color:#8a8a8a;margin:10px 0 0;">
                      Dates come from the manufacturer's published calendar and can move with little notice —
                      confirm before you plan around one.
                    </p>`
                  : ''
              }
...
function renderIssueText(issue, links) {
  ...
  if (issue.releases.length) {
    lines.push(
      "Dates come from the manufacturer's published calendar and can move with little notice — confirm before you plan around one.",
      ''
    );
  }
