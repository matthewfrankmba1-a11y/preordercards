...
// `headers` is a passthrough for per-message SMTP headers Resend forwards
// verbatim — currently only List-Unsubscribe/List-Unsubscribe-Post on the
// weekly newsletter, which mailbox providers use to render their own
// one-click unsubscribe control.
async function sendEmail({ to, subject, text, html, attachments, headers }) {
  try {
